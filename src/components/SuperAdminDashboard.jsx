...
const SuperAdminDashboard = () => {
  ...
  useEffect(() => {
    const loadShelters = async () => {
      try {
        const response = await fetch('/api/admin/shelters/pending', {
          headers: {
  ...
  const approveShelter = async (shelterId) => {
    ...
    try {
      const response = await fetch(`/api/admin/shelters/${shelterId}/approve`, {
        method: 'PATCH',
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
const rejectShelter = async (shelterId) => {
  ...
  try {
    const response = await fetch(`/api/admin/shelters/${shelterId}/reject`, {
      method: 'PATCH',
      headers: {
